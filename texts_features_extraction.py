...
def main(device: str, clip_type: str, inpath: str, outpath: str):
    ...
    encoder.load_state_dict(torch.load("./eval_step/checkpoint/clip-finetune_54_0.03756.pt", map_location="cuda:0", weights_only=True))
...
if __name__ == '__main__':
    ...
    idx = 2 # change here! 0 -> coco training data, 1 -> flickr30k training data
    device = 'cuda:0'
    ...
    'eval_step/artwiki_train_with_entities.pickle',
    'eval_step/artwiki_test_with_entities.pickle',
    ]
    outpath = [
    ...
    'eval_step/new/artwiki_train_texts_features_ft.pickle',
    'eval_step/new/artwiki_test_texts_features_ft.pickle',
    ]
    for idx in [2, 3]:
