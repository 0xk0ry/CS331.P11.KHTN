...
def main(args) -> None:
    ...
    checkpoint = torch.load('checkpoints/finetune_clip/ArtWiki10.pt', map_location="cuda:0", weights_only=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_path', default = 'checkpoints/artcap_prefix-finetune-059.pt')
    parser.add_argument('--clip_path', default = None)
    ...
    print('args: {}\n'.format(vars(args)))
    # python infer_by_instance.py --prompt_ensemble --using_hard_prompt --soft_prompt_first --image_path E:\cv\Dataset\ArtWiki\images\martiros-saryan_steppe-flowers-1909.jpg --weight_path checkpoints/finetune_clip/artcap_wikiart-finetune-029.pt
    main(args)