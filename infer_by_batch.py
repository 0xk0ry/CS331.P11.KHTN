...
if __name__ == '__main__':
    ...
    print('args: {}\n'.format(vars(args)))
    # python infer_by_batch.py --prompt_ensemble --using_hard_prompt --soft_prompt_first --image_path ../dataset/wikiart/images --outfile ../wiki-wo-lands.json --weight_path checkpoints/train_wikiart/wiki-w-lands-30.pt
    main(args)